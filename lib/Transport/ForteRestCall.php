<?php
namespace Shoukhin\Forte\Transport;

use Shoukhin\Forte\Core\ForteHttpConfig;
use Shoukhin\Forte\Core\ForteHttpConnection;

/**
 * Class ForteRestCall
 *
 * @package Shoukhin\Forte\Transport
 */
class ForteRestCall
{
    ...
    public function execute($handlers = array(), $path, $method, $data = '', $headers = array())
    {
        ...
        $httpConfig = new ForteHttpConfig(null, $method, $config);
        ...
        /** @var \Forte\Handler\IForteHandler $handler */
        ...
        $connection = new ForteHttpConnection($httpConfig, $config);

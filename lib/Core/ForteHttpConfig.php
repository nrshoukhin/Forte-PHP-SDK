...
/**
 * Class ForteHttpConfig
 * Http Configuration Class
 *
 * @package Shoukhin\Forte\Core
 */
...
class ForteHttpConfig
{
    ...
    public static $defaultCurlOptions = array(
        ...
        CURLOPT_USERAGENT => 'Forte-PHP-SDK',
     ...
     *
     * @param string $proxy
     * @throws ForteConfigurationException
     */
    public function setHttpProxy($proxy)
    {
        $urlParts = parse_url($proxy);
        if ($urlParts == false || !array_key_exists("host", $urlParts)) {
            throw new ForteConfigurationException("Invalid proxy configuration " . $proxy);
        }
